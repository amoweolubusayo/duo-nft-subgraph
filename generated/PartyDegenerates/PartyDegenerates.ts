...
export class PartyDegenerates extends ethereum.SmartContract {
  static bind(address: Address): PartyDegenerates {
    return new PartyDegenerates("PartyDegenerates", address);
  }
